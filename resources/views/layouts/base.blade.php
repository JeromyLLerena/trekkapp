...
<html lang="en">
    ...
    <head>
        ...
        <!-- Timeline CSS -->
        <link href="{{asset('startbootstrap-sb-admin-2-1.0.8/dist/css/timeline.css')}}" rel="stylesheet">

        <!-- Custom CSS -->
        <link href="{{asset('startbootstrap-sb-admin-2-1.0.8/dist/css/sb-admin-2.css')}}" rel="stylesheet">

        <!-- Morris Charts CSS -->
        <link href="{{asset('startbootstrap-sb-admin-2-1.0.8/bower_components/morrisjs/morris.css')}}" rel="stylesheet">
    ...
    @show
        ...
        <script src="{{asset('startbootstrap-sb-admin-2-1.0.8/bower_components/raphael/raphael-min.js')}}"></script>
        <!--
        <script src="{{asset('startbootstrap-sb-admin-2-1.0.8/bower_components/morrisjs/morris.min.js')}}"></script>
        <script src="{{asset('startbootstrap-sb-admin-2-1.0.8/js/morris-data.js')}}"></script>
        -->
